...
testprogram_c = objects if env.GetOption('analyze') else env.Program("test_c", source = objects)
...
testprogram_cpp = objects if env.GetOption('analyze') else env.Program("test_cpp", source = objects)
...
benchmarkprogram_c = objects if env.GetOption('analyze') else env.Program("benchmark_c", source = objects)
sources = [ "benchmark.cpp" ]
objects = env.Object("benchmark_cpp", source = sources)
benchmarkprogram_cpp = objects if env.GetOption('analyze') else env.Program("benchmark_cpp", source = objects)
